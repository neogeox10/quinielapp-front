                            ...
                            <div key={q._id} className="col-12 col-md-6 col-lg-4">
                                <div className="card shadow-sm border-0 h-100 hover-card">
                                    <div className="card-body p-4 d-flex flex-column text-center">
                                        ...
                                        {q.usuarios.length === 0 && <p className="text-danger  small mb-4"><i className="bi bi-emoji-frown me-2"></i>0 Participantes</p>}
                                        {q.usuarios.length === 1 && <p className="text-warning small mb-4"><i className="bi bi-controller me-2"></i>1 Participante</p>}
                                        {q.usuarios.length > 1 && <p className="text-primary small mb-4"><i className="bi bi-controller me-2"></i>{q.usuarios.length} Participantes</p>}
                                        ...
                                        <div className="mt-auto">
                                            ...
                                            {!q.bloqueada && q.usuarios.includes(usuario.id) &&
                                                <button
                                                ...
                                                >
                                                    ...
                                                    {q.yaJugada ? 'Editar Pronósticos' : 'Ingresar Pronósticos'}
                                                </button>
                                            }
                                            {q.bloqueada && q.usuarios.includes(usuario.id) &&
                                                <button
